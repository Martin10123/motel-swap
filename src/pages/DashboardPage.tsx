...
export function DashboardPage() {
  ...
  return (
    <div className="w-full space-y-6">
      {/* Page header */}
      <div>
        <h1 className="text-2xl! md:text-3xl! m-0! font-bold text-gray-900">
          Dashboard
        </h1>
          ...
          return (
            <Card key={stat.name} className="p-6">
              <div className="flex items-start justify-between">
                ...
                <div className="p-3 bg-[#0a1d3a] rounded-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-sm text-[#0a1d3a] font-medium hover:underline">
              Ver todas
            </button>
          </div>
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    {booking.status === 'confirmed' ? (
                      ...
                      <>
                        ...
                        <span className="text-xs text-blue-600">En curso</span>
                      </>
                    ) : (
                      <>
        ...
        <Card className="p-6">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Total habitaciones</span>
